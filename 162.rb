...
starts =
  (0...$max_row).map{|i| [[i, -1], RIGHT]} +
  (0...$max_col).map{|i| [[-1, i], DOWN]} +
  (0...$max_row).map{|i| [[$max_col, i], LEFT] }+
  (0...$max_col).map{|i| [[$max_row, i], UP] }
